<form method="POST" action="?controller=App\Controller\UserController&<?php echo isset($user['id']) ? "method=update&id={$user['id']}" : "method=save"; ?>" >
    <div class="form-group">
        <label>Name</label>
        <input name="name" value="<?php echo isset($user['name']) ? $user['name'] : null; ?>" class="form-control">
    </div>
    <div class="form-group">
        <label>Username</label>
        <input name="username" value="<?php echo isset($user['username']) ? $user['username'] : null; ?>" class="form-control">
    </div>
    <div class="form-group">
        <label>Email</label>
        <input name="email" value="<?php echo isset($user['email']) ? $user['email'] : null; ?>" class="form-control">
    </div>
    <div class="form-group">
        <label>Phone</label>
        <input name="phone" value="<?php echo isset($user['phone']) ? $user['phone'] : null; ?>" class="form-control">
    </div>
    <div class="form-group">
        <label>Website</label>
